    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Always consult our clinic or your healthcare provider before starting any new diet or workout plan. Recommendations may vary based on your pre-existing medical conditions.
        </p>
        <button
          onClick={onClose}
