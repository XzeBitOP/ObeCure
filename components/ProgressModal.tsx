...
const ProgressChart: React.FC<{ data: ChartDataPoint[] }> = ({ data }) => {
  ...
  const { weightDomain, calorieDomain, sharedDomain, xDomain } = useMemo(() => {
    ...
    const getDomain = (values: number[], pad: number, minSpread: number) => {
